...
export class HomeFAQComponent {
    ...
    constructor(public snackBar: MatSnackBar, private api: ApiService) {
        ...
        },
        {
          ...
          respuesta:' Para realizar el pago es necesario ir al sitio boletia y realizar el pago del taller corrrspondiente. Cualquier duda favor de contactar a angelica.cisneros@csoftmty.org'
        },
        {
