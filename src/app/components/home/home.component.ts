...
export class HomeComponent {
  ...
  ngOnInit() {
    window.location.href = 'https://www.ventanaindustriadesoftware.org/axtateen';
    // TODO este codigo de este repo ya no se usa. Se redirecciona para utilizar otra pagina completamente diferente. Para ver la pagina original comentar la linea de codigo de arriba.
  }
